...
const STARS = Array.from({ length: 125 }, (_, i) => ({
  id: i,
  x: Math.round(((((i * 7.3 + Math.sin(i * 2.1) * 22) % 100) + 100) % 100) * 10) / 10,
  y: Math.round(((((i * 5.9 + Math.cos(i * 1.7) * 18) % 100) + 100) % 100) * 10) / 10,
...
function StarryPhotoGrid({ photos }: { photos: string[] }) {
  ...
  if (photos.length === 1) {
    return (
      <div className="flex justify-center" style={{ animation: "fadeSlideUp 1s ease 0.6s both" }}>
        <div className="relative w-[210px]" style={{ aspectRatio: "3/4", ...goldFrame }}>
          <Image loading="eager" src={photos[0]} alt="Photo 1" fill className="object-cover" sizes="210px" />
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 65%, rgba(7,0,18,0.35) 100%)" }} />
        </div>
      </div>
    );
  }
  ...
  if (photos.length <= 3) {
    ...
    return (
      <div className="flex gap-3 justify-center items-end" style={{ animation: "fadeSlideUp 1s ease 0.6s both" }}>
        {photos.map((url, i) => (
          <div
            key={i}
          ...
          >
            <Image src={url} loading="eager" alt={`Photo ${i + 1}`} fill className="object-cover" sizes="(max-width: 640px) 33vw, 155px" />
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 65%, rgba(7,0,18,0.35) 100%)" }} />
          </div>
        ))}
      </div>
  ...
  if (photos.length === 4) {
    return (
      <div className="grid grid-cols-2 gap-3" style={{ animation: "fadeSlideUp 1s ease 0.6s both" }}>
        {photos.map((url, i) => (
          <div key={i} className="relative" style={{ aspectRatio: "4/3", ...goldFrame, animation: `fadeSlideUp 0.9s ease ${0.5 + i * 0.1}s both` }}>
            <Image src={url} loading="eager" alt={`Photo ${i + 1}`} fill className="object-cover" sizes="(max-width: 640px) 45vw, 195px" />
          </div>
        ))}
      </div>
    );
  ...
  // 5 photos: 3 + 2
  return (
    <div className="flex flex-col gap-3" style={{ animation: "fadeSlideUp 1s ease 0.6s both" }}>
      <div className="grid grid-cols-3 gap-2">
        {photos.slice(0, 3).map((url, i) => (
          <div key={i} className="relative" style={{ aspectRatio: "2/3", ...goldFrame }}>
            <Image src={url} loading="eager" alt={`Photo ${i + 1}`} fill className="object-cover" sizes="(max-width: 640px) 30vw, 135px" />
          </div>
        ))}
      </div>
      <div className="grid grid-cols-2 gap-2 px-10">
        {photos.slice(3).map((url, i) => (
          <div key={i + 3} className="relative" style={{ aspectRatio: "4/3", ...goldFrame }}>
            <Image src={url} loading="eager" alt={`Photo ${i + 4}`} fill className="object-cover" sizes="(max-width: 640px) 38vw, 170px" />
          </div>
        ))}
      </div>
    </div>
...
export default function StarryTemplate({ data }: { data: MomentData }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ background: "#070012" }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(110,35,160,0.32) 0%, rgba(80,20,120,0.14) 50%, transparent 75%)",
          filter: "blur(72px)",
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(180,40,110,0.22) 0%, rgba(140,20,80,0.1) 50%, transparent 75%)",
          filter: "blur(80px)",
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(50,20,140,0.25) 0%, rgba(30,10,100,0.1) 50%, transparent 75%)",
          filter: "blur(65px)",
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(200,120,40,0.13) 0%, rgba(160,80,20,0.06) 55%, transparent 80%)",
          filter: "blur(60px)",
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(160,50,100,0.16) 0%, rgba(120,30,80,0.07) 55%, transparent 80%)",
          filter: "blur(70px)",
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at center, transparent 30%, rgba(5,0,15,0.85) 100%)",
      ...
      {isClient && (
        <svg
          style={{ position: "fixed", inset: 0, width: "100%", height: "100%", pointerEvents: "none", zIndex: 1, opacity: 0.18, animation: "constellationPulse 14s ease-in-out infinite" }}
          viewBox="0 0 100 100"
          preserveAspectRatio="xMidYMid slice"
          aria-hidden="true"
        >
          <line x1="8"  y1="28" x2="20" y2="14" stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="20" y1="14" x2="38" y2="20" stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="38" y1="20" x2="52" y2="8"  stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="52" y1="8"  x2="68" y2="16" stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="68" y1="16" x2="82" y2="10" stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="82" y1="10" x2="93" y2="22" stroke="rgba(220,175,100,1)" strokeWidth="0.12" />
          <line x1="20" y1="14" x2="28" y2="34" stroke="rgba(220,175,100,1)" strokeWidth="0.08" />
          <line x1="52" y1="8"  x2="58" y2="28" stroke="rgba(220,175,100,1)" strokeWidth="0.08" />
          <line x1="68" y1="16" x2="72" y2="36" stroke="rgba(220,175,100,1)" strokeWidth="0.08" />
          ...
          {STARDUST.map((d) => (
            <div
              ...
              style={{
                ...
                height: `${d.size}px`,
                borderRadius: "50%",
                background: "radial-gradient(circle, rgba(230,200,140,0.9) 0%, rgba(200,160,80,0.4) 60%, transparent 100%)",
                opacity: 0,
      ...
      {showModal && data.music && (
        <div
          ...
          style={{ background: "rgba(4,0,14,0.92)", backdropFilter: "blur(22px)" }}
        >
          <div style={{
            position: "absolute", inset: 0, pointerEvents: "none",
            background: "radial-gradient(ellipse 50% 45% at 50% 50%, rgba(110,35,160,0.22) 0%, transparent 70%)",
          }} />

          <div
            className="w-full max-w-sm flex flex-col items-center gap-6 rounded-3xl p-8 relative"
            style={{
              background: "linear-gradient(160deg, rgba(22,8,50,0.97) 0%, rgba(12,4,32,0.99) 100%)",
              border: "1px solid rgba(201,168,76,0.35)",
              boxShadow: "0 0 100px rgba(110,35,160,0.2), 0 40px 80px rgba(0,0,0,0.8), 0 0 0 1px rgba(255,255,255,0.04)",
              animation: "fadeSlideUp 0.7s cubic-bezier(0.16,1,0.3,1) both",
            }}
          >
            <div style={{ animation: "floatGently 7s ease-in-out infinite" }}>
              <p style={{ color: "#C9A84C", fontSize: "1rem", letterSpacing: "0.65em", textShadow: "0 0 20px rgba(201,168,76,0.6)" }}>
                ✦ ✧ ✦
              </p>
            </div>
            ...
            {data.music.album_image && (
              <div style={{
                ...
                boxShadow: "0 0 50px rgba(110,35,160,0.35), 0 0 30px rgba(201,168,76,0.2), 0 10px 40px rgba(0,0,0,0.7)",
            ...
            <div className="text-center">
              <p style={{ color: "rgba(201,168,76,0.55)", fontSize: "10px", letterSpacing: "0.5em", textTransform: "uppercase", marginBottom: "10px" }}>
                a song for you
              </p>
              <p style={{
              ...
              <p style={{ color: "rgba(201,168,76,0.65)", fontSize: "0.9rem", marginTop: "6px" }}>
            ...
            <button
              ...
              style={{
                ...
                color: "#07000F",
                boxShadow: "0 6px 30px rgba(201,168,76,0.35), inset 0 1px 0 rgba(255,255,255,0.2)",
            ...
            <button
              ...
              style={{ color: "rgba(201,168,76,0.35)", fontSize: "11px", letterSpacing: "0.3em" }}
      ...
      >
        ...
        >
          <div style={{ height: "1px", width: "60px", background: "linear-gradient(to right, transparent, rgba(201,168,76,0.55))" }} />
          <span style={{ color: "rgba(201,168,76,0.6)", fontSize: "10px", animation: "floatGently 8s ease-in-out 1s infinite" }}>✦</span>
          <span style={{ color: "#C9A84C", fontSize: "14px", textShadow: "0 0 16px rgba(201,168,76,0.7)", animation: "floatGently 6s ease-in-out infinite" }}>✧</span>
          <span style={{ color: "rgba(201,168,76,0.6)", fontSize: "10px", animation: "floatGently 8s ease-in-out 2s infinite" }}>✦</span>
          <div style={{ height: "1px", width: "60px", background: "linear-gradient(to left, transparent, rgba(201,168,76,0.55))" }} />
        </div>
        ...
        <h1
          style={{
            ...
            lineHeight: 1.15,
            marginBottom: "16px",
            textShadow: "0 0 60px rgba(201,168,76,0.5), 0 0 120px rgba(110,35,160,0.3)",
            animation: "fadeSlideUp 1.3s cubic-bezier(0.16,1,0.3,1) 0.5s both, goldPulse 7s ease-in-out 2.5s infinite",
          }}
        >
        ...
        >
          <div style={{ height: "1px", width: "70px", background: "linear-gradient(to right, transparent, rgba(201,168,76,0.5))" }} />
          <span style={{ color: "rgba(201,168,76,0.7)", fontSize: "12px", animation: "floatGently 9s ease-in-out 3s infinite" }}>✦</span>
          <div style={{ height: "1px", width: "70px", background: "linear-gradient(to left, transparent, rgba(201,168,76,0.5))" }} />
        </div>
        ...
        <div
          ...
          style={{
            background: "linear-gradient(145deg, rgba(22,8,50,0.72) 0%, rgba(12,4,32,0.82) 100%)",
            backdropFilter: "blur(18px)",
            WebkitBackdropFilter: "blur(18px)",
            border: "1px solid rgba(201,168,76,0.28)",
            boxShadow: "0 0 0 1px rgba(255,255,255,0.03), inset 0 0 60px rgba(110,35,160,0.06)",
            animation: "fadeSlideUp 1.1s ease 0.95s both, cardGlow 8s ease-in-out 3s infinite",
          }}
        >
          {/* Corner star-glow accents */}
          <div style={{
            position: "absolute", top: 0, left: 0, width: "140px", height: "140px",
            background: "radial-gradient(circle at 0% 0%, rgba(201,168,76,0.18), transparent 70%)",
            pointerEvents: "none",
          }} />
          <div style={{
            position: "absolute", bottom: 0, right: 0, width: "140px", height: "140px",
            background: "radial-gradient(circle at 100% 100%, rgba(110,35,160,0.22), transparent 70%)",
            pointerEvents: "none",
          }} />
          ...
          {/* Top ornament */}
          <div style={{ textAlign: "center", marginBottom: "20px", animation: "floatGently 9s ease-in-out 2s infinite" }}>
            <span style={{ color: "#C9A84C", fontSize: "1rem", letterSpacing: "0.5em", textShadow: "0 0 18px rgba(201,168,76,0.6)" }}>
              ✦ ✧ ✦
            </span>
          </div>
          ...
          <div style={{ textAlign: "center", marginTop: "20px", animation: "floatGently 9s ease-in-out 4.5s infinite" }}>
            <span style={{ color: "#C9A84C", fontSize: "1rem", letterSpacing: "0.5em", textShadow: "0 0 18px rgba(201,168,76,0.6)" }}>
              ✦ ✧ ✦
            </span>
          </div>
        ...
        {/* Music player */}
        {showPlayer && (
          <div className="w-full flex flex-col items-center gap-4 mb-10" style={{ animation: "fadeSlideUp 0.8s ease both" }}>
            <div className="flex items-center gap-3">
              <div style={{ height: "1px", width: "44px", background: "rgba(201,168,76,0.3)" }} />
              <p style={{ color: "rgba(201,168,76,0.55)", fontSize: "10px", letterSpacing: "0.45em", textTransform: "uppercase" }}>
                a song for you
              </p>
              <div style={{ height: "1px", width: "44px", background: "rgba(201,168,76,0.3)" }} />
            </div>
            <div
              ...
              style={{
                borderRadius: "14px",
                overflow: "hidden",
                boxShadow: "0 0 40px rgba(110,35,160,0.2), 0 0 20px rgba(201,168,76,0.1), 0 8px 32px rgba(0,0,0,0.6)",
                width: "100%",
                minHeight: "80px",
              }}
            />
